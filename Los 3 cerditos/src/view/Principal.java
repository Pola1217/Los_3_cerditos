...
public class Principal extends PApplet {
	...
	//CERDITOS
	PImage CERDITO1, CERDITO2, CERDITO3;
	//CERDITOS CORRIENDO
	PImage CERDITO1C, CERDITO2C, CERDITO3C;
	
	//MATERIALES
	PImage MADERA, PAJA, LADRILLOS;
	
	//CASAS
	PImage CASAM, CASAP, CASAL;
	//CASAS BLOW
	PImage CASAMB, CASAPB;
	
	
	//LOBO
	PImage LOBO, LOBOSOPLA, LOBOBURN;
